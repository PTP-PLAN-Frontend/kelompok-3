...
export default function Bawangmerah () {
  return (
    ...
    <div className='bawangmerah-main'>
      ...
      3. Pada lahan dengan pH kurang 5,6 dilakukan pengapuran menggunakan kaptan/dolomite sebanyak 1-1,5 ton/ha/tahun bersamaan dengan pengolahan tanah yaitu minimal 2 minggu sebelum tanam.
      ...
      Sumber: https://jabar.litbang.pertanian.go.id/index.php/info-teknologi/607-budidaya-bawang-merah
      </p> 
    </div>
    </Container>
  );
